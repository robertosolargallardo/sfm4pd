...
template<unsigned int MODEL>
Pedestrian<MODEL>::Pedestrian(const uint32_t &_id,const double &_min_speed,const double &_max_speed,const double &_delay,const std::vector<std::vector<PositionGeo>> &_points){
	this->_id=_id;
